...
namespace app\models\Organization\Commands\Search;
...
/**
 * OrganizationsSearch represents the model behind the search form of `app\models\Organization\Objects\Entities\Organizations`.
 */
class OrganizationsSearch extends Organizations
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            [['role', 'website', 'address'], 'string', 'max' => 255],
